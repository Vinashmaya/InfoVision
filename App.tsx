...
const App: React.FC = () => {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check for specific billing, key, or unauthenticated errors
      if (
        ...
        errorMsg.includes("API keys are not supported")
          ...
          setError("Access denied or authentication failed. This model requires a valid API key from a project with billing enabled.");
          setHasApiKey(false); // Reset key state to force modal
      } else {
          setError('The service encountered an error. Please try a different topic or refresh.');
      }
    } finally {
      setIsLoading(false);
      setLoadingStep(0);
            ...
            <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed font-medium">
                        This application uses premium models that require credentials from a project with billing enabled.
                    </p>
                    ...
                    <div className="flex items-start gap-3">
                         ...
                         <div className="space-y-1">
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400">
                                Standard API keys may fail. Please ensure you have set up billing in Google AI Studio.
                            </p>
                             <a 
        ...
        {error && (
          <div className="max-w-2xl mx-auto mt-8 p-6 bg-red-100 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-2xl flex items-center gap-4 text-red-800 dark:text-red-200 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 shadow-sm">
            ...
            <div className="flex-1">
                ...
                {(error.includes("Access denied") || error.includes("billing") || error.includes("authentication")) && (
                    <button 
                        onClick={handleSelectKey}
